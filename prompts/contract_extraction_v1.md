...
11. Cumulative volume discounts: capture every tier in descending or ascending order; the deterministic engine will choose the highest qualifying threshold. Record the scope used for cumulative quantity.
